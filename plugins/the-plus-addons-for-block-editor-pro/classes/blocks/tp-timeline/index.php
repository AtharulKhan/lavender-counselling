...
function tpgb_tp_timeline() {
	...
	$attributesOptions = [
			...
			'RContent' => [
				...
				'default' => [ 
					['_key'=> '1','Rnone'=>'icon','Ricon'=>'fa fa-calendar','RcTitle'=>'Event 1','RTitle'=>'24-05-1995','RPosition'=>'right','RcType'=>'image','RUrl'=>['url'=>''],'RcAlign'=>'text-right','RSAlign'=>'left','Rdes'=>'Add your event description with style using all our options. You will love to use and add details over here.' , 'ajaxbase' => '' ],
					['_key'=> '2','Rnone'=>'icon','Ricon'=>'fa fa-calendar','RcTitle'=>'Event 2','RTitle'=>'24-05-1995','RPosition'=>'left','RcType'=>'image','RUrl'=>['url'=>''],'RcAlign'=>'text-left','RSAlign'=>'right','Rdes'=>'Add your event description with style using all our options. You will love to use and add details over here.', 'ajaxbase' => '' ],
				],
			],
