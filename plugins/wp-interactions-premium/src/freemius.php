...
if ( ! class_exists( 'WPI_Freemius_Admin' ) ) {
	class WPI_Freemius_Admin {

		/**
		 * The current instance of the class.
		 * @var WPI_Freemius_Admin
		 */
		private static $instance = null;
		...
		/**
		 * WPI_Freemius_Admin constructor.
		 *
		 * @param $freemius
		 * @param $args
		 */
...
<dialog class="license_activate_dialog {$esc_attr( $dialog_class )}" id="dialog-{$esc_attr( $this->freemius->plugin_id )}">
	<div>
