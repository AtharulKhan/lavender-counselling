...
if ( ! class_exists( 'WPI_Location_Post_Type' ) ) {
	class WPI_Location_Post_Type extends WPI_Location {

		public function initialize() {
			$this->name = 'post_type';
			$this->label = __( 'Post type', 'wp-interactions' );
			$this->category = 'post';
		}
		...
		public function is_match( $screen, $operator, $value ) {
			return $this->compare_to_rule( $screen->post_type, $operator, $value );
		}
	}

	wpi_add_location_rule_type( 'post_type', 'WPI_Location_Post_Type' );
}
