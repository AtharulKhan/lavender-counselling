...
if ( ! class_exists( 'WPI_Location_Post_Taxonomy' ) ) {
	class WPI_Location_Post_Taxonomy extends WPI_Location {

		public function initialize() {
			$this->name = 'post_taxonomy';
			$this->label = __( 'Post taxonomy', 'wp-interactions' );
			$this->category = 'post';
		}
	...
	wpi_add_location_rule_type( 'post_taxonomy', 'WPI_Location_Post_Taxonomy' );
}
