...
if ( ! class_exists( 'WPI_Location_Page_Template' ) ) {
	class WPI_Location_Page_Template extends WPI_Location {

		public function initialize() {
			$this->name = 'page_template';
			$this->label = __( 'Page template', 'wp-interactions' );
			$this->category = 'page';
		}
	...
	wpi_add_location_rule_type( 'page_template', 'WPI_Location_Page_Template' );
}
